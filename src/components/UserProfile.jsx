...
function UserProfile() {
  ...
  return (
    <div className="relative" ref={profileRef}>
      {/* Profile Card - Clickable/Hoverable */}
      <div
      ...
      {showProfile && (
        <div className="absolute bottom-full left-0 right-0 mb-2 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 z-50 max-h-[80vh] overflow-y-auto">
          {!isEditing ? (
            // View Mode
            <>
