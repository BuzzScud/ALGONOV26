    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      {filteredNotes.length === 0 ? (
        ...
        <>
          ...
          {/* Horizontal Card View with Popover */}
            ...
            {filteredNotes.map((note) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`relative flex flex-col sm:flex-row bg-white dark:bg-gray-800 rounded-xl border ${color.border} ${color.dark} shadow-md hover:shadow-lg transition-all overflow-hidden cursor-default ${
                      selectedNotes.includes(note.id) ? 'ring-2 ring-blue-500' : ''
                    }`}
                  >
                    {/* Colored Sidebar/Image Area */}
                    <div className={`flex-shrink-0 w-full sm:w-48 h-32 sm:h-auto bg-gradient-to-br ${color.bg} ${color.dark} flex items-center justify-center relative`}>
                      ...
                      <div className="text-center p-4">
                        ...
                        <span className={`text-xs font-medium mt-2 block ${color.text}`}>
                          {color.name}
                        </span>
                      </div>
                    </div>
                  ...
                  {/* Popover - Shows full content on hover (positioned below) */}
                  <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 z-50 w-[90%] max-w-lg opacity-0 invisible group-hover/card:opacity-100 group-hover/card:visible transition-all duration-200 pointer-events-none group-hover/card:pointer-events-auto">
                    ...
                    <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-2xl border ${color.border} ${color.dark} overflow-hidden`}>
                      {/* Popover Header */}
